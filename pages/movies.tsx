      ...
      <div className="flex flex-col items-center justify-center">
        <div className="max-w-3xl px-4">
            ...
            <p className="text-sm sm:text-base text-neutral-700 mt-3 sm:mt-6 px-2 text-center pb-10">
                I&apos;ve always loved movies, so I&apos;ve been using the app Letterboxd to review all the movies I watch. You can see the latest movies I reviewed in Letterboxd below.
            </p>
